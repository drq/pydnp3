...
from outstation_test import OutstationTestApplication
...
class OutstationTestCmd(cmd.Cmd):
    """
    ...
    def __init__(self):
        ...
        self.application = OutstationTestApplication()
...
def main():
    cmd_interface = OutstationTestCmd()
