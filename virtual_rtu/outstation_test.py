...
class OutstationTestApplication(opendnp3.IOutstationApplication):
    """
    ...
    def __init__(self):
        super(OutstationTestApplication, self).__init__()
        ...
        OutstationTestApplication.set_outstation(self.outstation)
    ...
    def configure_stack():
        ...
        stack_config.outstation.params.allowUnsolicited = False # True
    ...
    def apply_update(self, value, index):
        ...
        OutstationTestApplication.get_outstation().Apply(update)
...
class OutstationCommandHandler(opendnp3.ICommandHandler):
    ...
    def Select(self, command, index):
        ...
        """
        OutstationTestApplication.process_point_value('Select', command, index, None)
    ...
    def Operate(self, command, index, op_type):
        ...
        :return: CommandStatus
        """
        OutstationTestApplication.process_point_value('Operate', command, index, op_type)
        return opendnp3.CommandStatus.SUCCESS
